...
from backend.app.domain.models import UnifiedOffer, TripType, SourceType, Itinerary, Segment, LayoverCategory
from backend.app.services.layover_classifier import classify_offer, classify_many
