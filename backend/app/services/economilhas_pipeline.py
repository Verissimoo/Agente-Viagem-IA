...
from backend.app.providers.economilhas.parser import (
...
# ──────────────────────────────────────────────────────────────────
# All Economilhas-sourced offers share `SourceType.ECONOMILHAS`. The specific
# program lives in the `miles_program` field so the UI can label it (Smiles,
# LATAM Pass, ...). CPM resolution in `conversion.py` uses the `airline`
# label below, which matches keys in `rates.json`.
PROGRAM_TO_SOURCE: Dict[str, Tuple[SourceType, str, Optional[str]]] = {
    "SMILES":         (SourceType.ECONOMILHAS, "GOL",       "Smiles"),
    "LATAM":          (SourceType.ECONOMILHAS, "LATAM",     "LATAM Pass"),
    "AZUL":           (SourceType.ECONOMILHAS, "AZUL",      "TudoAzul"),
    "AZUL_INTERLINE": (SourceType.ECONOMILHAS, "INTERLINE", "Azul Pelo Mundo"),
    "COPA":           (SourceType.ECONOMILHAS, "COPA",      "ConnectMiles"),
    "IBERIA":         (SourceType.ECONOMILHAS, "IBERIA",    "Avios"),
    "BRITISH":        (SourceType.ECONOMILHAS, "BRITISH AIRWAYS", "Avios"),
}


# ──────────────────────────────────────────────────────────────────
# SearchRequest builder (mirrors search_orchestrator)
# ──────────────────────────────────────────────────────────────────
